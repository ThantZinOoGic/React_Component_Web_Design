        ...
        <div className="row py-5">
          ...
          <div className="col-6 col-lg-4">
            ...
            <p className="d-flex justify-content-between col-7">
              <i
                class="bg-secondary text-white rounded-circle fs-lg p-2 mr-2 fa fa-instagram"
                aria-hidden="true"
              ></i>
              <i
                class="bg-secondary text-white rounded-circle fs-lg p-2 mr-2 fa fa-twitter"
                aria-hidden="true"
              ></i>
              <i
                class="bg-secondary text-white rounded-circle fs-lg p-2 mr-2 fa fa-facebook"
                aria-hidden="true"
              ></i>
              <i
                class="bg-secondary text-white rounded-circle fs-lg p-2 mr-2 fa fa-linkedin"
                aria-hidden="true"
              ></i>
              <i
                class="bg-secondary text-white rounded-circle fs-lg p-2 mr-2 fa fa-pinterest-p"
                aria-hidden="true"
              ></i>
            </p>
          </div>
          ...
          <div className="fw-light text-center my-5">
